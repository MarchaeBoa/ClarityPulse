...
const comparisons: ComparisonRow[] = [
  { feature: "Sem cookies", clarity: "yes", ga4: "no", gaNote: "Usa cookies de rastreamento" },
  { feature: "GDPR compliant sem config", clarity: "yes", ga4: "no", gaNote: "Requer consent mode" },
  { feature: "Dados 100% (sem amostragem)", clarity: "yes", ga4: "partial", gaNote: "Amostra acima de 500k" },
  { feature: "Script < 5kb", clarity: "yes", clarityNote: "4.8kb", ga4: "no", gaNote: "45kb+" },
  { feature: "Dashboard intuitivo", clarity: "yes", ga4: "partial", gaNote: "Curva de aprendizado alta" },
  { feature: "Realtime nativo", clarity: "yes", ga4: "partial", gaNote: "Delay de 24-48h em reports" },
  { feature: "IA Insights automáticos", clarity: "yes", ga4: "no" },
  { feature: "Relatórios por email", clarity: "yes", ga4: "partial", gaNote: "Limitado" },
  { feature: "Funis de conversão", clarity: "yes", ga4: "yes" },
  { feature: "Eventos customizados", clarity: "yes", ga4: "yes" },
  { feature: "Sem limite de dados", clarity: "yes", clarityNote: "Por plano", ga4: "yes" },
  { feature: "Suporte dedicado", clarity: "yes", ga4: "no", gaNote: "Apenas fórum" },
  { feature: "Dados na EU", clarity: "yes", ga4: "partial", gaNote: "Requer configuração" },
  { feature: "Setup em < 5 min", clarity: "yes", ga4: "partial", gaNote: "30-60 min com GTM" },
];
    ...
    <div className="flex items-center gap-2">
      {status === "yes" && (
        <div className="w-5 h-5 rounded-full bg-jade/10 flex items-center justify-center">
          <Check size={12} className="text-jade" strokeWidth={2} />
        </div>
      )}
      {status === "no" && (
      ...
      {note && <span className="text-[10px] font-mono text-ghost/40">{note}</span>}
    </div>
  );
}
