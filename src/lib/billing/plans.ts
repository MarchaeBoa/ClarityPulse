...
export type PlanSlug = "free" | "starter" | "growth" | "team" | "enterprise";
...
export interface AILimits {
  insightsInterval: string;       // human-readable interval
  insightsIntervalMs: number;     // milliseconds between insights
...
export const PLANS: Record<PlanSlug, PlanDefinition> = {
  // ----------------------------------------------------------
  // FREE — O gancho de entrada
  // ----------------------------------------------------------
  free: {
    slug: "free",
    name: "Free",
    tagline: "Para sempre grátis",
    description: "Perfeito para sites pessoais e projetos iniciais",
    priceMonthly: 0,
    priceYearly: 0,
    priceYearlyTotal: 0,
    maxSites: 1,
    maxMembers: 1,
    maxPageviewsMonth: 10_000,
    maxCustomEvents: 5,
    dataRetentionDays: 90,
    dataRetentionLabel: "3 meses",
    ai: {
      insightsInterval: "Sem IA",
      insightsIntervalMs: -1,
      chatMessagesPerDay: 0,
      chatEnabled: false,
    },
    supportLevel: "community",
    supportResponseTime: "Fórum da comunidade",
    features: [
      "dashboard",
      "realtime",
      "custom_events",
...
export const PLAN_ORDER: PlanSlug[] = ["free", "starter", "growth", "team", "enterprise"];

/** Plans available for self-serve purchase (excludes free and enterprise) */
...
export const COMPARISON_TABLE: ComparisonRow[] = [
  // Limites
  { label: "Sites", category: "Limites", values: { free: "1", starter: "3", growth: "10", team: "Ilimitado", enterprise: "Ilimitado" } },
  { label: "Pageviews/mês", category: "Limites", values: { free: "10k", starter: "100k", growth: "1M", team: "5M", enterprise: "Ilimitado" } },
  { label: "Membros", category: "Limites", values: { free: "1", starter: "2", growth: "10", team: "Ilimitado", enterprise: "Ilimitado" } },
  { label: "Eventos customizados", category: "Limites", values: { free: "5 tipos", starter: "20 tipos", growth: "Ilimitado", team: "Ilimitado", enterprise: "Ilimitado" } },
  { label: "Retenção de dados", category: "Limites", values: { free: "3 meses", starter: "1 ano", growth: "2 anos", team: "5 anos", enterprise: "Ilimitada" } },

  // Analytics
  { label: "Dashboard completo", category: "Analytics", values: { free: true, starter: true, growth: true, team: true, enterprise: true } },
  { label: "Realtime", category: "Analytics", values: { free: true, starter: true, growth: true, team: true, enterprise: true } },
  { label: "Goals de conversão", category: "Analytics", values: { free: false, starter: true, growth: true, team: true, enterprise: true } },
  { label: "Funis de conversão", category: "Analytics", values: { free: false, starter: false, growth: true, team: true, enterprise: true } },
  { label: "Session Replay", category: "Analytics", values: { free: false, starter: false, growth: false, team: true, enterprise: true } },

  // IA
  { label: "IA Insights", category: "Inteligência Artificial", values: { free: false, starter: "A cada 12h", growth: "A cada 4h", team: "A cada 1h", enterprise: "Tempo real" } },
  { label: "Pulse AI Chat", category: "Inteligência Artificial", values: { free: false, starter: "20 msgs/dia", growth: "100 msgs/dia", team: "Ilimitado", enterprise: "Ilimitado" } },
  { label: "Alertas inteligentes", category: "Inteligência Artificial", values: { free: false, starter: false, growth: true, team: true, enterprise: true } },

  // Exportação
  { label: "Export CSV", category: "Exportação", values: { free: true, starter: true, growth: true, team: true, enterprise: true } },
  { label: "Export PDF", category: "Exportação", values: { free: false, starter: true, growth: true, team: true, enterprise: true } },
  { label: "API REST", category: "Exportação", values: { free: false, starter: false, growth: true, team: true, enterprise: true } },
  { label: "Relatórios automáticos", category: "Exportação", values: { free: false, starter: "Semanal", growth: "Diário", team: "Custom", enterprise: "Custom" } },

  // Integrações
  { label: "Slack + Zapier", category: "Integrações", values: { free: false, starter: true, growth: true, team: true, enterprise: true } },
  { label: "Google/Meta/TikTok Ads", category: "Integrações", values: { free: false, starter: false, growth: true, team: true, enterprise: true } },
  { label: "Webhooks customizados", category: "Integrações", values: { free: false, starter: false, growth: false, team: false, enterprise: true } },

  // Time
  { label: "Roles (Admin/Editor/Viewer)", category: "Time", values: { free: false, starter: false, growth: true, team: true, enterprise: true } },
  { label: "Roles customizados", category: "Time", values: { free: false, starter: false, growth: false, team: true, enterprise: true } },
  { label: "SSO / SAML", category: "Time", values: { free: false, starter: false, growth: false, team: false, enterprise: true } },
  { label: "Audit Log", category: "Time", values: { free: false, starter: false, growth: false, team: true, enterprise: true } },
  { label: "White Label", category: "Time", values: { free: false, starter: false, growth: false, team: false, enterprise: true } },

  // Suporte
  { label: "Suporte", category: "Suporte", values: { free: "Comunidade", starter: "Email (24h)", growth: "Email (4h)", team: "Email + Chat (2h)", enterprise: "Dedicado 24/7" } },
  { label: "Onboarding dedicado", category: "Suporte", values: { free: false, starter: false, growth: false, team: false, enterprise: true } },
  { label: "DPA dedicado", category: "Suporte", values: { free: false, starter: false, growth: false, team: false, enterprise: true } },
  { label: "SLA customizado", category: "Suporte", values: { free: false, starter: false, growth: false, team: false, enterprise: true } },
];
